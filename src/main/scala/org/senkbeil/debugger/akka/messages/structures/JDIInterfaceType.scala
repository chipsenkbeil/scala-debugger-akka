...
/*case*/ class JDIInterfaceType(
  ...
  // Specific
  val implementors:         Option[Seq[JDIClassType]]     = None,
  val subinterfaces:        Option[Seq[JDIInterfaceType]] = None,
  val superinterfaces:      Option[Seq[JDIInterfaceType]] = None
